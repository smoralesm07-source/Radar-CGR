...
`integration_manifest_v1.json` describe cómo este radar se integra al sistema. `interop_contract_v1.schema.json` fija el contrato común y `validate_interop.py` lo valida sin dependencias externas.
